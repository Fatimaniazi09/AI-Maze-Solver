    ...
    while open_set:
        ...
        for n in get_neighbors(curr):
            ...
            if tg < g_score[n]:
                came_from[n] = curr
                g_score[n]   = tg
                heapq.heappush(open_set, (tg + h(n, e), n))
...
def run_dijkstra(s, e):
    """Dijkstra's algorithm — optimal for all non-negative weighted graphs."""
    open_set  = [(0, s)]
    came_from = {}
    ...
    while open_set:
        ...
        for n in get_neighbors(curr):
            ...
            if new_dist < dist[n]:
                dist[n]      = new_dist
                came_from[n] = curr
                heapq.heappush(open_set, (new_dist, n))
